...
while ! mysqladmin ping -h mariadb-container --silent; do
...
wp core config --dbhost=mariadb-container:3306 --dbname="$MYSQL_DB" --dbuser="$MYSQL_USER" --dbpass="$MYSQL_PASSWORD" --allow-root
